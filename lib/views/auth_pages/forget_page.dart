...
import '../../services/auth_service/forget_service.dart';
...
class _ForgetPageState extends State<ForgetPage> {
  ...
  final ForgetService _forgetService = ForgetService();
  ...
  void initState() {
    super.initState();
    _futurePage = _cmsService.fetchPage("forget");
  }
                      ...
                      child: DynamicButton(
                        ...
                        onPressed: () async {
                          if (btn.identifiant == "sendOtp") {
                            ...
                            // Envoi de la requête
                            final response = await _forgetService.sendOtp(numero);
